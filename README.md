...
## The Greatest Attract Screens of all Time
...
To see if your joystick works with SAM, you can run this command (assuming your joystick is js0) from ssh and start pushing buttons:  
